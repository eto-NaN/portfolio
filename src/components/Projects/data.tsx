...
export const ProjectsCardTab: PorjectCard[] = [
...

  {
    ...
    year: 2026,
    shortDescription:
      "Network library in cpp easy to use for UDP and TCP networking.",
    bigDescription:
      "This project is a network library in C++ that provides easy-to-use abstractions for UDP and TCP networking. We bring all the tools needed to build network applications such as easy creation and usage of servers and clients, basic message handling, a logger to watch the network traffic etc.",
